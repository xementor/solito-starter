...
function NavigationRail() {
  return (
    <div className="bg-surface-200 dark:bg-surfacedark-200 fixed bottom-0 left-0 right-0 z-50 flex w-full flex-row items-center gap-8 py-4 md:top-0 md:h-screen md:w-24 md:flex-col">
      {/* <!-- logo --> */}
      <a
        href="https://aribudin.github.io/tailmater/"
        target="_blank"
        className="relative mb-8 hidden md:flex"
      >
        <div
          aria-label="Tailmater - Tailwind Material 3 UI"
      ...
      {/* <!-- list menu --> */}
      <div className="flex w-full flex-row items-center justify-center md:w-auto md:flex-col md:gap-4">
        <a
          href="index.html"
          className="active group flex min-h-[56px] w-1/4 flex-col items-center justify-center gap-1 px-0 md:w-auto"
        >
          <div className="hover-icon group-hover:bg-secondary-100 dark:group-hover:bg-secondary-700 relative flex h-8 w-14 items-center justify-center rounded-2xl group-hover:bg-opacity-80 dark:group-hover:bg-opacity-80">
            <span
              className="material-symbols-outlined"
              style={{
                fontFamily: `"Material Symbols Outlined", Bangla1014, sans-serif`,
              }}
            >
              widgets
            </span>
          </div>
          <p className="text-xs leading-tight tracking-[.0416em] text-neutral-900 dark:text-neutral-100">
            Components
          </p>
        </a>
        ...
        <a
          href="colors.html"
          className="group flex min-h-[56px] w-1/4 flex-col items-center justify-center gap-1 px-0 md:w-auto"
        >
          <div className="hover-icon group-hover:bg-secondary-100 dark:group-hover:bg-secondary-700 relative flex h-8 w-14 items-center justify-center rounded-2xl group-hover:bg-opacity-80 dark:group-hover:bg-opacity-80">
            <span
              className="material-symbols-outlined"
      ...
      <div className="mt-auto hidden flex-col items-center gap-3 md:flex">
        ...
        >
          {/* <!-- download --> */}
          <a
            href="https://github.com/aribudin/tailmater"
            target="_blank"
